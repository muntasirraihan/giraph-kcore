...
public class KCoreInputFormat extends
  TextVertexInputFormat<LongWritable, KCoreVertexValue,
    LongWritable> {

  @Override
  public TextVertexReader createVertexReader(InputSplit split,
      TaskAttemptContext context) {
    return new KCoreInputFormatVertexReader();
  }

 /**
  * Vertex Reader use for the KCore Algorithm
  ...
  * [1,0,[[2,0],[3,1],[4,1]]]
  */
  class KCoreInputFormatVertexReader
    ...
    @Override
    protected KCoreVertexValue getValue(JSONArray jsonVertex)
      throws JSONException, IOException {
      /**
      * Currently the core value is unused when initializing a vertex.
      */
      return new KCoreVertexValue();
    }
    ...
    @Override
    protected Vertex<LongWritable, KCoreVertexValue,
